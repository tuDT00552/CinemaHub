...
@Service
public class FilesStorageService implements vn.cinemahub.cinemahub.service.FilesStorageService {
...
/*
    ...
    public void save(MultipartFile uploadfile) {
        try {
            ...
            Files.copy(uploadfile.getInputStream(), this.root.resolve(uploadfile.getOriginalFilename()));
        } catch (Exception e) {
            throw new RuntimeException("Could not store the file. Error: " + e.getMessage());
        }
    }
